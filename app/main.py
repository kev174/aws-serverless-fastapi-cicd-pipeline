...
# https://lsh8cin25k.execute-api.us-east-2.amazonaws.com/Dev/kevin/6
...
def main_endpoint_test2(item_id: int):
    return {"Welcome Kevin Cusack to your /kevin endpoint CI/CD Pipeline with GitHub Actions and updated yamlll! Id sent=": item_id}
